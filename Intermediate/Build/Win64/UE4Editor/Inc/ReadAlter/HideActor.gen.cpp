...
// Cross Module References
	READALTER_API UClass* Z_Construct_UClass_AHideActor_NoRegister();
	READALTER_API UClass* Z_Construct_UClass_AHideActor();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_ReadAlter();
	READALTER_API UFunction* Z_Construct_UFunction_AHideActor_DisableActor();
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AHideActor_DisableActor_Statics::NewProp_toHide = { "toHide", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HideActor_eventDisableActor_Parms), &Z_Construct_UFunction_AHideActor_DisableActor_Statics::NewProp_toHide_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AHideActor_DisableActor_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "HideActor.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AHideActor_DisableActor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AHideActor, nullptr, "DisableActor", nullptr, nullptr, sizeof(HideActor_eventDisableActor_Parms), Z_Construct_UFunction_AHideActor_DisableActor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AHideActor_DisableActor_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AHideActor_DisableActor_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AHideActor_DisableActor_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AHideActor_Statics::NewProp_HideInGame = { "HideInGame", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AHideActor), &Z_Construct_UClass_AHideActor_Statics::NewProp_HideInGame_SetBit, METADATA_PARAMS(Z_Construct_UClass_AHideActor_Statics::NewProp_HideInGame_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AHideActor_Statics::NewProp_HideInGame_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AHideActor_Statics::ClassParams = {
		...
		DependentSingletons,
		FuncInfo,
		Z_Construct_UClass_AHideActor_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		UE_ARRAY_COUNT(FuncInfo),
		UE_ARRAY_COUNT(Z_Construct_UClass_AHideActor_Statics::PropPointers),
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AHideActor_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AHideActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AHideActor, 2741361641);
	template<> READALTER_API UClass* StaticClass<AHideActor>()
	{
		return AHideActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AHideActor(Z_Construct_UClass_AHideActor, &AHideActor::StaticClass, TEXT("/Script/ReadAlter"), TEXT("AHideActor"), false, nullptr, nullptr, nullptr);
